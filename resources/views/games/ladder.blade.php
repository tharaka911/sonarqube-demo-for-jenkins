...
<head>
    ...
    <title>Unity WebGL Player | Speed Ladder</title>
    <link rel="shortcut icon" href="{{ asset('games/ladder/TemplateData/favicon.ico') }}">
    <link rel="stylesheet" href="{{ asset('games/ladder/TemplateData/style.css') }}">
    <script src="{{ asset('games/ladder/TemplateData/UnityProgress.js') }}"></script>
    <script src="{{ asset('games/ladder/Build/UnityLoader.js') }}"></script>
    <script>
        var unityInstance = UnityLoader.instantiate("unityContainer",
            "{{ asset('games/ladder/Build/webgl_build_10-10_v2.json') }}", {
